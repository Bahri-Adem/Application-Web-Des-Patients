		      ...
		      <div class="notifications">
		        ...
		        <div class="notification_dd">
		            ...
		            <ul class="notification_ul">
		                ...
		                <li class="show_all">
		                    <a href="/Cabinet/RendezVous?type=N" class="link">Afficher toutes les Rendez-Vous</a>
		                </li> 
		            </ul>
		        </div>
	        ...
	        <div>
	            ...
	            <div class="nav__list">
	                ...
	                <a href="/Cabinet/RendezVous?type=H" class="nav__link">
	               	...
	               	<a href="/Cabinet/All_Consultation" class="nav__link">
	                    <i class='bx bx-briefcase nav__icon' ></i>
	                    <span class="nav__name">Consultations</span>
	                </a>
	            </div>
	        </div>
