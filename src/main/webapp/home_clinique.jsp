...
<%
CliniqueDAO cliicDao = new CliniqueDAO();
User user = (User) session.getAttribute("user");
Clinique cl = cliicDao.getCliniqueById(user.getId_user());
%>
...
<body id="body-pd">
	...
	<div class="container-fluid" style="padding-top: 5rem;">
		...
		<div class="row">
			...
			<div class="col-4">
				<a href="/Cabinet/All_Sejour">
					<div class="box">
						<div class="imgBx">
							<img src="images/clnic.png" width="250px" height="300">
						</div>
						<p class="text">Les Sejours</p>
						<div class="details">
							<h5>Tous les Sejours</h5>
						</div>
					</div>
				</a>
			</div>
			<div class="col-4">
				<a href="/Cabinet/AddSejour">
					<div class="box">
						<div class="imgBx">
							<img src="images/medecin.png" width="250px" height="300">
						</div>
						<p class="text">Ajouter Sejour</p>
						<div class="details">
							<h4>Ajouter un Sejour</h4>
						</div>
					</div>
				</a>
			</div>
