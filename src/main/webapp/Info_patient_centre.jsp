	...
	<div class="container-fluid" style="margin-top: 100px;">
		...
		<div class="row">
			...
			<div class="card shadow mb-4" style="width: 100%;">
				...
				<div class="my-3"></div>
				<a href="/Cabinet/Radiographies" class="btn btn-success btn-icon-split"
					style="margin-left: 15px; width: 23%;"> <span
					class="icon text-white-50"> <i class="fa fa-plus"
						aria-hidden="true"></i>
				</span> <span class="text">Ajouter une Radiographie</span>
				</a>
				<div class="card-body">
						...
						<table class="table table-bordered" style="color: black;"
			                ...
			                %>
								<tr>
									...
									<td>
										<form action="/Cabinet/Info_patient?id_p=<%=radio.getPatient().getId_user()%>"
											method="POST">

											<input type="hidden" name="id_radiographie"
												value="<%=radio.getId_radiographie() %>" />
											<button type="button" class="btn btn-danger"
												data-toggle="modal" data-target="#ModalDelete<%=id3 %>">
												<i class="far fa-trash-alt"></i>
											</button>
											<div class="modal" id="ModalDelete<%=id3 %>"
