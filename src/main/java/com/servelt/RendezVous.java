...
public class RendezVous extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type.equals("A")) {
			...
			this.getServletContext().getRequestDispatcher("/ListeRenderVous.jsp").forward(request, response);
		}
			...
			this.getServletContext().getRequestDispatcher("/H_RendezVous.jsp").forward(request, response);
		}
	}
