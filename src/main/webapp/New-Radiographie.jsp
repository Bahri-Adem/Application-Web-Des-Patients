...
<html lang="en">
	...
	<head>
	    ...
	    <title>Ajouter une Radiographie</title>
	</head>
    ...
    <body id="body-pd">
    	...
    	<div class="container-fluid" style="padding-top:5rem;">	        	
	        ...
	        <div class="d-sm-flex align-items-center justify-content-between mb-4">
	            <h1 class="h3 mb-0 text-gray-800">Ajouter une Radiographie </h1>
	        </div>
	            ...
	            <div class="col-xl-12 col-lg-10">
	                <div class="card shadow mb-4">
	                    ...
	                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
	                        <h6 class="m-0 font-weight-bold text-primary">Les informations de Radiographie</h6>
	                    </div>
	                    
	                    <!-- Card Body -->
	                    <div class="card-body">
		                    <form action="Radiographies" method="POST">
		                  		<div class="mb-3">								  
								  	<label class="form-label">Type de Radiographie </label>
								    <input type="text"  class="form-control" name="type_radiographie" id="type_radiographieId" required>
								</div>
		                    	<div class="form-row d-flex flex-column pb-3">
		                               <label for="treatment">Centre de Radiographie :</label>
			               ...
			               %>
								...
								<div class="mb-3">								  
								  	<label class="form-label">Date de Radiographie </label>
								    <input type="datetime-local"  class="form-control" name="datetime" id="datetimeId" required>
								</div>
								<div class="mb-3">								  
								  	<label class="form-label">Resultat de Radiographie </label>
