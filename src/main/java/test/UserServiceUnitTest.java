...
public class UserServiceUnitTest {
    ...
    public void userShouldBeLogin() throws SQLException {
        ...
        Patient patient = new Patient(50,"UB98226","abderrahmane","kotbi","0633559921","1993-01-01","kotbi@gmail.com", "password");
    ...
    public void userShouldBeRegisteredAndExist() throws SQLException {
        UserDAO userDAO = new UserDAO();
        Patient patient = new Patient(51, "UB98226", "dokali", "mohamed", "06542525", "d.mohamed@gmail.com", "password", "1993-01-01", "homme");
        assertEquals(0,userDAO.register(patient));
        assertTrue(userDAO.isExist("d.mohamed@gmail.com","UB98226"));
    }
