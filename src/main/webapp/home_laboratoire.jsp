...
Laboratoire cl = laboDao.getLaboratoireById(user.getId_user());
%>
...
<body id="body-pd">
	...
	<div class="container-fluid" style="padding-top: 5rem;">
		...
		<div class="row">
			...
			<div class="col-4">
				<a href="/Cabinet/All_Analyse">
					<div class="box">
						<div class="imgBx">
							<img src="images/analyse.png" width="250px" height="300">
						</div>
						<p class="text">Les Analyses</p>
						<div class="details">
							<h3>Tous les Analyses</h3>
						</div>
					</div>
				</a>
			</div>
			<div class="col-4">
				<a href="/Cabinet/Analyses">
					<div class="box">
						<div class="imgBx">
							<img src="images/analy.png" width="250px" height="300">
						</div>
						<p class="text">Ajouter Analyses</p>
						<div class="details">
